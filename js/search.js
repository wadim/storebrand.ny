...
function initExtendedSearch(){
  ...
  function minimizeSearch()
  {
	...
	function displaySearchResult(xml) {
	 ...
	 // S塥r det p塴ide 塬egge p塳elve treffene.
	  $(xml).find("R").each(function () {
	    // Vi behandler "promotions" spesielt, og resten p塥n annen m浥
	    // F𲳴 promotions, som alltid kommer f𲳴 hvis de kommer
	    if ($(this).find("SL_MAIN").length > 0) {
	      ...
	      // S塩kke-promotions (som vanligvis er det som kommer)
